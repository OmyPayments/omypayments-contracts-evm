...
const config = {
  ...
  networks: {
    ...
    ethereumMainnet: {
      ...
      accounts: [process.env.OWNER_PK_OMY, process.env.OWNER_PK_OMY_2],
      chainId: 1
    },
    ethereumGoerli: {
      url: process.env.NETWORK_HOST_ETHEREUM_GOERLI,
      accounts: [process.env.OWNER_PK_OMY_TEST],
      chainId: 5
    },
    ethereumSepolia: {
    ...
    bscMainnet: {
      ...
      accounts: [process.env.OWNER_PK_OMY, process.env.OWNER_PK_OMY_2],
      // accounts: [process.env.OWNER_PK_OMY_2, process.env.OWNER_PK_OMY],
      chainId: 56
    },
    bscTestnet: {
